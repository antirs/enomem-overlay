...
IUSE="bzip2 doc ldap nls readline selinux +smartcard ssl static static-libs test +tofu tpm tools usb user-socket wks-server"
RESTRICT="!test? ( test )"
...
LIB_DEPEND="
	>=dev-libs/libassuan-2.5.0:=[static-libs?]
	>=dev-libs/libgcrypt-1.9.1:=[static-libs?]
	>=dev-libs/libgpg-error-1.46[static-libs?]
	>=dev-libs/libksba-1.6.3[static-libs?]
	...
	tofu? ( >=dev-db/sqlite-3.27[static-libs?] )
	tpm? ( >=app-crypt/tpm2-tss-2.4.0:=[static-libs?] )
	ssl? ( >=net-libs/gnutls-3.2:0=[static-libs?] )
"
RDEPEND="
	!static? ( ${LIB_DEPEND} )
	nls? ( virtual/libintl )
...
PDEPEND="
	...
	>=dev-libs/libgpg-error-1.46[static?]
"
BDEPEND="
	virtual/pkgconfig
