...
IUSE="ada +cxx debug doc gpm minimal noshared profile split-usr +stack-realign static static-libs test tinfo trace"
...
src_configure() {
	...
	use static && append-ldflags $(test-flags-CC -static)
