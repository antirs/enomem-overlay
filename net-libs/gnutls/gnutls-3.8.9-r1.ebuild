...
IUSE="brotli +cxx dane doc examples +idn nls noshared +openssl pkcs11 sslv2 sslv3 static-libs test test-full +tls-heartbeat tools zlib zstd"
...
LIB_DEPEND="
	>=dev-libs/libtasn1-4.9:=[${MULTILIB_USEDEP},static-libs]
	dev-libs/libunistring:=[${MULTILIB_USEDEP},static-libs]
	>=dev-libs/nettle-3.10:=[gmp,${MULTILIB_USEDEP},static-libs]
	>=dev-libs/gmp-5.1.3-r1:=[${MULTILIB_USEDEP},static-libs]
	brotli? ( >=app-arch/brotli-1.0.0:=[${MULTILIB_USEDEP},static-libs] )
	dane? ( >=net-dns/unbound-1.4.20:=[${MULTILIB_USEDEP},static-libs] )
	nls? ( >=virtual/libintl-0-r1:=[${MULTILIB_USEDEP}] )
	pkcs11? ( >=app-crypt/p11-kit-0.23.1[${MULTILIB_USEDEP},static-libs] )
	idn? ( >=net-dns/libidn2-0.16-r1:=[${MULTILIB_USEDEP},static-libs] )
	zlib? ( sys-libs/zlib[${MULTILIB_USEDEP},static-libs] )
	zstd? ( >=app-arch/zstd-1.3.0:=[${MULTILIB_USEDEP},static-libs] )
"
