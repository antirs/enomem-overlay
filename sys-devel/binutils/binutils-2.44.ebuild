...
LICENSE="GPL-3+"
IUSE="cet debuginfod doc gprofng hardened multitarget +nls pgo +plugins static static-libs test vanilla xxhash zstd"
...
DEPEND="
	...
	zstd? (
		static? ( app-arch/zstd:=[static-libs] )
	)
