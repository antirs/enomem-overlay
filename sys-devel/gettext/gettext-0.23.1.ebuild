...
SLOT="0"
IUSE="acl +cxx doc emacs git java ncurses nls noshared openmp static static-libs xattr"
...
LIB_DEPEND="
	>=virtual/libiconv-0-r1[${MULTILIB_USEDEP},static-libs?]
	>=virtual/libintl-0-r2[${MULTILIB_USEDEP},static-libs?]
	>=dev-libs/libxml2-2.9.3:=[static-libs?]
