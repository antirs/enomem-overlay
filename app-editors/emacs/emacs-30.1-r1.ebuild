...
IUSE="acl alsa aqua athena cairo dbus dynamic-loading games gfile gif +gmp gpm gsettings gtk gui gzip-el harfbuzz imagemagick +inotify jit jpeg kerberos lcms libxml2 livecd m17n-lib mailutils motif png selinux sound source static static-libs sqlite ssl svg systemd +threads tiff toolkit-scroll-bars tree-sitter valgrind webp wide-int +X xattr Xaw3d xft +xpm zlib"
...
REQUIRED_USE="
		...
		xft? ( !static )
"
X_DEPEND="!static? ( x11-libs/libICE
	x11-libs/libSM
	x11-libs/libX11
...
LIB_DEPEND="
	...
	dbus? ( sys-apps/dbus[static-libs?] )
	games? ( acct-group/gamestat )
	gmp? ( dev-libs/gmp:0=[static-libs?] )
	gpm? ( sys-libs/gpm[static-libs?] )
	!inotify? ( gfile? ( >=dev-libs/glib-2.28.6[static-libs?] ) )
	jit? (
		sys-devel/gcc:=[jit(-)]
		sys-libs/zlib
	)
	...
	libxml2? ( >=dev-libs/libxml2-2.2.0[static-libs?] )
	mailutils? ( net-mail/mailutils[clients] )
	!mailutils? ( acct-group/mail net-libs/liblockfile )
	selinux? ( sys-libs/libselinux[static-libs?] )
	sqlite? ( dev-db/sqlite:3[static-libs?] )
	ssl? ( net-libs/gnutls:0=[static-libs?] )
...
STATIC_PATCHES=(
	"${FILESDIR}"/emacs-static-hash-table.patch
)
