...
LICENSE="vim"
SLOT="0"
IUSE="X acl crypt cscope debug gpm lua minimal nls perl python racket ruby selinux sound static static-libs tcl terminal vim-pager"
REQUIRED_USE="
...
LIB_DEPEND="
	...
	>=sys-libs/ncurses-5.2-r2:0=[static-libs?]
	nls? ( virtual/libintl[static-libs?] )
	acl? ( kernel_linux? ( sys-apps/acl[static-libs?] ) )
	crypt? ( dev-libs/libsodium:=[static-libs?] )
	cscope? ( dev-util/cscope )
	gpm? ( >=sys-libs/gpm-1.19.3[static-libs?] )
	lua? ( ${LUA_DEPS}
