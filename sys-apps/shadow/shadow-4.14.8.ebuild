...
IUSE="acl audit cracklib nls pam selinux skey split-usr noshared nostatic static static-libs su systemd xattr"
...
COMMON_DEPEND="
	...
	cracklib? ( >=sys-libs/cracklib-2.7-r3:=[static-libs?] )
	nls? ( virtual/libintl[static-libs?] )
	pam? ( sys-libs/pam:= )
	skey? ( sys-auth/skey:= )
	selinux? (
		>=sys-libs/libselinux-1.28:=[static-libs?]
