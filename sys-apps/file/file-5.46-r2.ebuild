...
LIB_DEPEND="
	...
	lzma? ( app-arch/xz-utils[${MULTILIB_USEDEP},static-libs?] )
	seccomp? ( >=sys-libs/libseccomp-2.5.4[${MULTILIB_USEDEP},static-libs?] )
	zlib? ( >=sys-libs/zlib-1.2.8-r1[${MULTILIB_USEDEP},static-libs?] )
	zstd? ( app-arch/zstd:=[${MULTILIB_USEDEP},static-libs?] )
	python? (
		${PYTHON_DEPS}
