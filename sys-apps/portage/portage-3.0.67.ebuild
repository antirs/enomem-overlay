...
LICENSE="GPL-2"
SLOT="0"
IUSE="apidoc build doc gentoo-dev +ipc +native-extensions +rsync-verify selinux static test xattr"
...
RDEPEND="
	...
	!static? ( elibc_glibc? ( >=sys-apps/sandbox-2.2 ) )
	!static? ( elibc_musl? ( >=sys-apps/sandbox-2.2 ) )
