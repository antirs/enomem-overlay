...
inherit flag-o-matic systemd tmpfiles prefix
...
LICENSE="GPL-3"
SLOT="0"
IUSE="+manpager nls noshared +seccomp selinux static static-libs zlib"

CDEPEND="
	>=dev-libs/libpipeline-1.5.0[static-libs?]
	>=sys-apps/groff-1.20.0
	sys-libs/gdbm:=[static-libs?]
